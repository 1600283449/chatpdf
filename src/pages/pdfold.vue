<template>
	<div class="flex" >
		<div class="exchange">
			...
			<!-- 聊天框 -->
			<div class="content">
				<div class="flexcenter allcontents" :style="{'height':contrastData?'50%':'90%'}" ref='pondModel'>
					<!-- 对比按钮 -->
					...
					<div class="contents" v-if="src" ref="problem">
						<div class="pdfname flexAlignCenter">
							...
							<div class="pdfnames">chatgpt-4 <span v-if="my_time[0].chatTime!=''">duration:{{my_time[0].chatTime}}s</span></div>
						</div>
					...
					<div class="contents" v-if="src" ref="problems">
						<div class="pdfname flexAlignCenter">
							<div class="pdfColor"></div>
							<div class="pdfnames">{{$route.query.allmodelname}} <span v-if="my_time[1].modelTime!=''">duration:{{my_time[1].modelTime}}s</span></div>
						</div>
						<div class="charts" v-for="v in list">
							<img src="../assets/heard.png" class="chartimg" v-if="v.state==1">
							<img src="../assets/AI.png" class="chartimgs" v-if="v.state==2">
		...
		<div class="exchange">
			...
			<div class="pdfs" ref="pdf" @scroll.passive="getScroll($event)" v-if="src">
				<pdf v-for="i in numPages" :key="i" :src="src" :page="i"
					style="width: 100%;margin-bottom: 20px;" :style="{'height':pdfheight}">
